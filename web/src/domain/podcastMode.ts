...
const LEGACY_DEFAULT_REHEARSAL_SCRIPT: Record<Language, string> = {
...
export function shouldSeedPodcastTemplate(content: string): boolean {
  ...
  return [...Object.values(DEFAULT_REHEARSAL_SCRIPT), ...Object.values(LEGACY_DEFAULT_REHEARSAL_SCRIPT)]
    .some((script) => script === normalized);
}
